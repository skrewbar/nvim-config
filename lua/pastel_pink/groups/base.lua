...
function M.get(c, opts)
  ...
  return {
    ...
    PmenuMatch                  = { bg = c.bg_popup, fg = c.pink_pastel }, -- Popup menu: Matched text in normal item.
    PmenuSel                    = { bg = c.bg_selection }, -- Popup menu: selected item.
    PmenuMatchSel               = { bg = c.bg_selection, fg = c.pink_pastel }, -- Popup menu: Matched text in selected item.
    ...
    IncSearch                   = { bg = Util.blend_bg(c.orange, 0.5), fg = c.fg }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
    CurSearch                   =  "IncSearch",
    ...
    Visual                      = { bg = "#544242" }, -- Visual mode selection
    VisualNOS                   = { bg = "#544242" }, -- Visual mode selection when vim is "Not Owning the Selection".
    ...
    Keyword                     = { fg = c.pink, style = opts.styles.keywords }, --  any other keyword (make logical keywords pink)
    Operator                    = { fg = c.pink }, -- "sizeof", "+", "*", etc. (operators in pink)
    PreProc                     = { fg = c.cyan }, -- (preferred) generic Preprocessor
    Special                     = { fg = c.pink_light }, -- (preferred) any special symbol
    Statement                   = { fg = c.pink_pastel }, -- (preferred) any statement
    String                      = { fg = c.string }, --   a string constant: "this is a string"
    Todo                        = { bg = c.yellow, fg = c.bg }, -- (preferred) anything that needs extra attention; mostly the keywords TODO FIXME and XXX
    Type                        = { fg = c.purple }, -- (preferred) int, long, char, etc. (make types purple)
    Tag                         = { fg = c.magenta2 },
    Underlined                  = { underline = true }, -- (preferred) text that stands out, HTML links
    vimCommand                  = { fg = c.pink_pastel }, -- Vim command names (cmdline syntax)
    vimCommandModifier          = { fg = c.pink_pastel }, -- Vim command modifiers
    vimIsCommand                = { fg = c.pink_pastel }, -- Vim command detection in cmdline
    vimOnlyCommand              = { fg = c.pink_pastel }, -- Vim-only commands
    vimUsrCmd                   = { fg = c.pink_pastel }, -- User commands starting with uppercase in cmdline
    ...
    LspReferenceText            = { bg = "#544242" }, -- used for highlighting "text" references
    LspReferenceRead            = { bg = "#544242" }, -- used for highlighting "read" references
    LspReferenceWrite           = { bg = "#544242" }, -- used for highlighting "write" references
