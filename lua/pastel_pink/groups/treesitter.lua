...
function M.get(c, opts)
  ...
  local ret = {
    ...
    ["@function.macro.vim"]         = { fg = c.pink_pastel },
    ["@function.method"]            = "Function",
    ["@function.method.call"]       = "@function.method",
    ["@keyword"]                    = { fg = c.yellow, style = opts.styles.keywords }, -- For keywords that don't fall in previous categories.
    ...
    ["@keyword.function"]           = { fg = c.blue, style = opts.styles.functions }, -- For keywords used to define a function.
    ...
    ["@number"]                     = "Number",
    ["@number.float"]               = "Float",
    ["@operator"]                   = { fg = c.pink }, -- For any operator: `+`, but also `->` and `*` in C. (make operators pink)
    ...
    ["@variable"]                   = { fg = c.fg, style = opts.styles.variables }, -- Any variable name that does not have another highlight. (bright)
    ["@variable.builtin"]           = { fg = c.red_desaturated }, -- Variable names that are defined by the languages, like `this` or `self`. (desaturated red)
    ["@variable.member"]            = { fg = c.green1 }, -- For fields.
    ["@variable.parameter"]         = { fg = c.fg }, -- For parameters of a function. (bright)
