...
function M.get(c, opts)
  ...
  local ret = {
    ...
    -- Dashboard
    SnacksDashboardNormal     = { fg = c.fg, bg = opts.transparent and c.none or c.bg },
    SnacksDashboardDesc       = { fg = c.fg_dark },
    SnacksDashboardFile       = { fg = c.pink },
    SnacksDashboardFooter     = { fg = c.fg },
    ...
    SnacksPickerListCursorLine= { bg = c.bg_tree_selection },
